# $MCom: portstools/tinderbox/Makefile,v 1.86 2014/02/22 23:12:21 marcus Exp $
...
MIGDATA=	build_ports.map build_ports_queue.map builds.map config.map \
		...
		mig_mysql_tinderbox-3.3_to_4.0.0.sql \
		mig_pgsql_tinderbox-3.3_to_4.0.0.sql \
		mig_mysql_tinderbox-4.0.0_to_4.0.1.sql \
		mig_pgsql_tinderbox-4.0.0_to_4.0.1.sql \
		mig_sqlite_tinderbox-4.0.0_to_4.0.1.sql
